    ...
    <div class="row">
        ...
        <div class="col-md-4 column" style="float: right">
            ...
            <form class="form-inline" action="${pageContext.request.contextPath}/book/queryBook" method="post">
                <input type="text" name="queryBookName" class="form-control" style="display: inline"  placeholder="请输入要查询的书籍名称">
                ...
                <c:forEach var="book" items="${list}">
                    <tr>
                        ...
                        <td>
                            ...
                            &nbsp;|&nbsp;
                            <a href="${pageContext.request.contextPath}/book/deletBook/${book.bookID}">删除</a>
                        </td>
                    </tr>
                </c:forEach>
                </tbody>
